...
namespace NewGroup18_ARS
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=DESKTOP-UUG2AVV;Initial Catalog=NewGroup18_ARS;Integrated Security=True");
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            string arrivalTime = DH.Text+":"+DM.Text+":00";
            string departureTime = AH.Text + ":" +AM.Text+ ":00";
